      ...
      <Box bgImage={logo} p={26} h="auto" w="100%">
        <Flex w={"75%"} h="auto"  m="auto" mt={5} boxShadow= "rgba(0, 0, 0, 0.24) 0px 3px 8px"  p={15}  borderRadius="10px" bg="white">
            ...
            <Box h="auto" bg="black" p={10} borderRadius="10px">
                ...
                <Text color="blue" fontSize={19}>Category :  <span style={{fontFamily:"sans-serif",color:"white"}}> {user.brand}</span></Text><br/>
                </Box>
               ...
               <Link to="/kid"> <Button color="white" bg="#4299E1" border="1px solid white"  borderRadius="5px">GO Back</Button></Link><br/><br/>
                <Button color="white" bg="#4299E1" border="1px solid white" onClick={CartFunction}  borderRadius="5px">Add To Cart</Button>
                </Flex>
            </Box>
        </Flex>
      </Box>
